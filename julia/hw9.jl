...
MLPreprocessing.transform(lstat_scaled, scaler)
...
# plotting
# https://github.com/JuliaComputing/JuliaDB.jl/blob/master/docs/src/plotting.md
...
using JuliaDB:loadtable

chunked_table = loadtable("BostonHousing.csv", output="bin", chunks=100)
